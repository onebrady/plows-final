          ...
          switch (category.file) {
            ...
            case "kb-hydraulics-controls.json":
              contentModule = await import(
                `../../data/kb-hydraulics-controls.json`
              );
              break;
            ...
            case "kb-control-strategies.json":
              contentModule = await import(
                `../../data/kb-control-strategies.json`
              );
              break;
            case "kb-maintenance-safety.json":
              contentModule = await import(
                `../../data/kb-maintenance-safety.json`
              );
              break;
            default:
      ...
      >
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-black text-truckcorp-black uppercase mb-4">
            Snow & Ice Equipment
            <br />
            <span className="text-truckcorp-orange-500">Knowledge</span>
          </h1>
          <p className="text-xl text-snow-700 max-w-3xl mx-auto">
            Comprehensive guidance for municipal and commercial winter road
            maintenance operations. Select a category to explore detailed
